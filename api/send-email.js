                    ...
                    <tr>
                      <td style="padding: 40px;">
                        ...
                        <div style="text-align: center; margin: 32px 0;">
                          <a href="https://providus-admin-panel.vercel.app" style="display: inline-block; background-color: #FDB813; color: #1e293b; text-decoration: none; padding: 14px 32px; border-radius: 6px; font-weight: 600; font-size: 16px;">
                            Access Admin Portal
                          </a>
                        </div>
